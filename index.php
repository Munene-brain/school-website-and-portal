...
<html lang="zxx">
<head>
<title>school an Education Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="school web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/banner1.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">TOTAL STUDENTS</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
			...
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='30' data-delay='.5' data-increment="1">30</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/T002.jpg" alt="">
				  <h5>Mr Kenneth</h5>
				  <div class="about_opa">
					<p>Headteacher</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/T001.jpg" alt="">
				  <h5>Darponia</h5>
				  <div class="about_opa">
					<p>Deputy Head</p>
					<ul class="fb_icons2 text-center">
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com">thishoool@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>0745611564</li>
					<li><i class="fa fa-fax" aria-hidden="true"></i>www.thisschool.com</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2020 school. All rights reserved | Design by <a href="http://w3layouts.com">....</a> Developed...</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 school. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(0.4371, 36.9580),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(0.4371, 36.9580),
						map: map,
					});
				}
			</script>
